...
const Jetstar = ({ className, ...props }: IconProps) => {
	return (
		<svg
			className={className}
			{...props}
		...
		>
			<rect width='173' height='32' fill='url(#pattern0_1_434)' />
			<defs>
				<pattern
					id='pattern0_1_434'
				...
				>
					<use
						xlinkHref='#image0_1_434'
						transform='matrix(0.00363336 0 0 0.0196429 0 -1.25)'
					/>
				</pattern>
				<image
					id='image0_1_434'
